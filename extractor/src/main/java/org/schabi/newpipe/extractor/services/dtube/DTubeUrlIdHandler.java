...
public class DTubeUrlIdHandler extends ListUrlIdHandler {
    ...
    public String getPermId() throws ParsingException {
    ...
    public String getAuthor() throws ParsingException {
    ...
    public Object[] getSteemitParams() throws ParsingException {
